      ...
      <div class="row align-items-center h-100">
        <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" action="<?=base_url('Welcome/traitement_login')?>" method="Post">
          ...
          <div class="form-group">
            ...
            <input type="text" name ="Nom" id="Nom" class="form-control form-control-lg" placeholder="Nom" required="" autofocus="">
          </div>
          <div class="form-group">
            <label for="Motdepasse" class="sr-only">Motdepasse</label>
            <input type="password" name ="Motdepasse" id="Motdepasse" class="form-control form-control-lg" placeholder="Mot_de_passe" required="">
          </div>
