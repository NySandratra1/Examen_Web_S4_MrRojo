              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="card shadow mb-4">
                    <div class="card-body">
                        <form action = "<?=base_url('CodeController/insertCode')?>" method="Post">
                      <p class="h3 mb-3"><strong>Insertion code</strong></p>
                      ...
                      <div class="form-group mb-3">
                        ...
                        <input type="number" id="simpleinput" class="form-control" name="montant">
                      </div>
